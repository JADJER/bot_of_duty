...
template <typename T>
struct printf_formatter { printf_formatter() = delete; };
...
FMT_DEPRECATED auto vfprintf(
    std::basic_ostream<Char>& os, const S& fmt, basic_format_args<basic_printf_context_t<type_identity_t<Char>>> args)
    -> int {
    basic_memory_buffer<Char> buffer;
    vprintf(buffer, to_string_view(fmt), args);
